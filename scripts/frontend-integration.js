 ...
 * This file demonstrates how to integrate Rollupengine with a web frontend
 */

// For React/Vue/Angular applications
export class RollupengineClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new RollupengineClient(provider, contractAddress);
