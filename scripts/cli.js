...
const contractABI = require("../artifacts/contracts/Rollupengine.sol/Rollupengine.json").abi;

program
    .name("rollupengine-cli")
    .description("CLI tool for Rollupengine smart contract")
    .version("1.0.0");
